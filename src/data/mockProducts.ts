...
export const mockProducts: ExtendedProduct[] = [
  ...
  },
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?ixlib=rb-4.0.3',
    rating: 4.6,
  ...
  },
  {
    ...
    sale_price: 19.99,
    category: 'Electronics',
    tags: ['smartphone', 'accessories', 'gadgets'],
    image_url: 'https://images.unsplash.com/photo-1586953208448-b95a79798f07?ixlib=rb-4.0.3',
    rating: 4.3,
  ...
  },
  {
    id: '11',
    name: 'Plant Pot Set',
    description: 'Set of 3 ceramic plant pots with bamboo trays',
    price: 34.99,
    category: 'Home & Living',
    tags: ['home', 'decor', 'plants'],
    image_url: 'https://images.unsplash.com/photo-1485955900006-10f4d324d411?ixlib=rb-4.0.3',
    rating: 4.5,
  ...
  },
  {
    ...
    description: 'Vacuum insulated water bottle that keeps drinks hot or cold',
    price: 29.99,
    category: 'Sports',
    tags: ['bottle', 'hydration', 'eco-friendly'],
    image_url: 'https://images.unsplash.com/photo-1602143407151-7111542de6e8?ixlib=rb-4.0.3',
    rating: 4.8,
  ...
  },
  {
    ...
    description: 'Multi-functional desk organizer with pen holder and drawers',
    price: 42.99,
    category: 'Home & Living',
    tags: ['office', 'organizer', 'desk'],
    image_url: 'https://images.unsplash.com/photo-1547949003-9792a18a2601?ixlib=rb-4.0.3',
    rating: 4.4,
  ...
  },
  {
    ...
    description: 'Stylish glasses that reduce eye strain from digital screens',
    price: 32.99,
    sale_price: 27.99,
    category: 'Accessories',
    tags: ['glasses', 'computer', 'eye protection'],
    image_url: 'https://images.unsplash.com/photo-1591076482161-42ce6da69f67?ixlib=rb-4.0.3',
    rating: 4.2,
  ...
  },
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1608043152269-423dbba4e7e1?ixlib=rb-4.0.3',
    rating: 4.7,
  ...
  },
  {
    ...
    description: 'Set of 4 natural soy wax candles in different fragrances',
    price: 36.99,
    category: 'Home & Living',
    tags: ['candles', 'home', 'fragrance'],
    image_url: 'https://images.unsplash.com/photo-1608383610266-a39f3a3981bc?ixlib=rb-4.0.3',
    rating: 4.6,
  ...
  },
  {
    ...
    description: 'Lightweight fitness band with heart rate and sleep monitoring',
    price: 69.99,
    sale_price: 59.99,
    category: 'Electronics',
    tags: ['fitness', 'wearable', 'health'],
    image_url: 'https://images.unsplash.com/photo-1576243345690-4e4b79b63288?ixlib=rb-4.0.3',
    rating: 4.5,
    createdAt: '2024-03-24T15:10:00Z',
    stock_status: 'in_stock',
    stock_quantity: 45
  },
  {
    ...
    description: 'Refillable leather journal with premium paper',
    price: 28.99,
    category: 'Accessories',
    tags: ['notebook', 'stationery', 'journal'],
    image_url: 'https://images.unsplash.com/photo-1544816155-12df9643f363?ixlib=rb-4.0.3',
    rating: 4.4,
